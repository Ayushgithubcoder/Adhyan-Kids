...
variable "geo_location" {
  ...
  default     = [{failover_priority = 0, location = "centralus"}]
}
variable "nextjs_service_image" {
  description = "Container image for nextjs-service"
  type        = string
  default     = "mcr.microsoft.com/azuredocs/containerapps-helloworld:latest"
}

variable "nginx_gateway_node_version" {
  description = "Node.js version for nginx-gateway"
  type        = string
  default     = "20-lts"
}
